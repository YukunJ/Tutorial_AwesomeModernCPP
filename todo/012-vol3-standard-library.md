...
### M1: 迁移 `02-type-safe-register-access.md` 至 vol8 ✅ 已确认
...
### M2: 迁移 `03-circular-buffer.md` 和 `04-intrusive-containers.md` 至 vol8 ✅ 已确认
