...
> ⚠️ **Pitfall Warning**
> Many beginners see ``ref = other;`` and mistakenly think this is "rebinding." In reality, C++ has no syntax for "rebinding a reference" at all—all assignments to a reference are assignments to the referenced object. If you need "rebindable" semantics, what you need is not a reference, but a pointer.
